...
class MockTreatment {
  List<TreatmentModel> getListTreatment() {
    return mockListTreatment;
  }
  ...
  List<TreatmentModel> mockListTreatment = [
    ...
    TreatmentModel(
      ...
      imageUrl: 'https://hotpotstory.vn/wp-content/uploads/2023/10/GS-3.jpg',
      point: 0,
    ),
    TreatmentModel(
      id: "treatment_006",
      ...
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPnsrIyVuLFb_5C9n-hOHOBqnXYvSE8MFtxQ&s',
      point: 0,
    ),
    TreatmentModel(
      id: "treatment_007",
      ...
      content:
          ...
          'Điểm cộng lớn nhất vẫn là dịch vụ chăm sóc khách hàng “thần thánh” làm nên thương hiệu Haidilao. Từ nhân viên chào đón, hướng dẫn tận tình, cho đến các dịch vụ miễn phí như làm móng, đồ ăn nhẹ trong lúc chờ… tất cả đều góp phần tạo nên một trải nghiệm ẩm thực trọn vẹn và khác biệt.\n',
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThzlQCO9RXDo_Hd0Rs8T8WgEbWjwronZOHag&s',
      point: 0,
    ),
    TreatmentModel(
      id: "treatment_008",
      ...
      content:
          ...
          'Điểm cộng lớn nhất vẫn là dịch vụ chăm sóc khách hàng “thần thánh” làm nên thương hiệu Haidilao. Từ nhân viên chào đón, hướng dẫn tận tình, cho đến các dịch vụ miễn phí như làm móng, đồ ăn nhẹ trong lúc chờ… tất cả đều góp phần tạo nên một trải nghiệm ẩm thực trọn vẹn và khác biệt.\n',
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlBiP8hJuOyrYchqKY9MSQ9Nj1ZEO434VnGg&s',
      point: 0,
    ),
    TreatmentModel(
      id: "treatment_009",
      ...
      content:
          ...
          'Điểm cộng lớn nhất vẫn là dịch vụ chăm sóc khách hàng “thần thánh” làm nên thương hiệu Haidilao. Từ nhân viên chào đón, hướng dẫn tận tình, cho đến các dịch vụ miễn phí như làm móng, đồ ăn nhẹ trong lúc chờ… tất cả đều góp phần tạo nên một trải nghiệm ẩm thực trọn vẹn và khác biệt.\n',
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTYnyT_p4oFNjR8tOHy_7jBTLtzkmp2_erBA&s',
      point: 0,
    ),
    TreatmentModel(
      id: "treatment_010",
      ...
      content:
          ...
          'Điểm cộng lớn nhất vẫn là dịch vụ chăm sóc khách hàng “thần thánh” làm nên thương hiệu Haidilao. Từ nhân viên chào đón, hướng dẫn tận tình, cho đến các dịch vụ miễn phí như làm móng, đồ ăn nhẹ trong lúc chờ… tất cả đều góp phần tạo nên một trải nghiệm ẩm thực trọn vẹn và khác biệt.\n',
      imageUrl:
          'https://topgo.vn/wp-content/uploads/2024/11/Uu-dai-Quan-nho-1.jpg',
      point: 0,
    ),
    TreatmentModel(
      id: "treatment_011",
      ...
      content:
          ...
          'Điểm cộng lớn nhất vẫn là dịch vụ chăm sóc khách hàng “thần thánh” làm nên thương hiệu Haidilao. Từ nhân viên chào đón, hướng dẫn tận tình, cho đến các dịch vụ miễn phí như làm móng, đồ ăn nhẹ trong lúc chờ… tất cả đều góp phần tạo nên một trải nghiệm ẩm thực trọn vẹn và khác biệt.\n',
      imageUrl:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ09eIOqA33m7_GIABXdgk24xZvNrN_UilycA&s',
      point: 0,
    ),
  ];
}
