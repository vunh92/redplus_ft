...
class MockBanner {
  ...
  List<BannerModel> mockListBanner = [
    ...
    BannerModel(
      id: "banner_001",
      title: 'Cách Đặt Lẩu Haidilao Về Nhà Tiện Lợi | Thưởng Thức Ngay! Cách Đặt Lẩu Haidilao Về Nhà Tiện Lợi | Thưởng Thức Ngay!',
      content:
    ...
    BannerModel(
      ...
      content: 'Tọa lạc tại “Quận Ocean” sầm uất phía Đông thủ đô, Haidilao Ocean Park đã nhanh chóng trở thành điểm hẹn ẩm thực không thể bỏ lỡ của người dân Hà Nội. Nổi bật với không gian hiện đại, dịch vụ chăm sóc khách hàng đỉnh cao và thực đơn lẩu trứ danh, đây là lựa chọn hoàn hảo cho mọi cuộc vui từ hẹn hò, sum họp gia đình đến tụ tập bạn bè.\n'
