...
class _SignUpScreenState extends State<SignUpScreen> {
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              if (matches.length > 1) {
                                final previousRoute = matches[matches.length - 2].matchedLocation;
                                if (previousRoute == AppRouteConstants.signInRoute.path) {
                                  if (context.canPop()) {
                                    context.pop();
                                  }
                                } else {
                                  context.pushNamed(
                                    AppRouteConstants.signInRoute.name,
                                  );
                                }
                              } else {
                                context.pushNamed(
  ...
  _appBarWidget() {
    return AppBar(
      title: Text(_Constant().labelSignUp, style: TextStyle(fontWeight: FontWeight.bold)),
      actions: [
